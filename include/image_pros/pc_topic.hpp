...
#include "image_pros/msg/hole_center_msg2.hpp"
...
class PcTopic : public rclcpp::Node {
    ...
    private:
        ...
        rclcpp::Subscription<image_pros::msg::HoleCenterMsg2>::SharedPtr center_subscription_;

        void pc_callback(const sensor_msgs::msg::PointCloud2::SharedPtr cloud_msg);
        void center_callback(const image_pros::msg::HoleCenterMsg2::SharedPtr center_msg);

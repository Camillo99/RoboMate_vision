#include "image_pros/pc_topic.hpp"    //include the class PcTopic
  ...
  PcTopic::PcTopic() 
      :  Node("pc_topic")
      {
        ...
        pc_subscription_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
                                  ...
                                  this,
                                  std::placeholders::_1));
        center_subscription_ = this->create_subscription<image_pros::msg::HoleCenterMsg2>(
                            "/hole_center_2D", 10,
...
void PcTopic::pc_callback(const sensor_msgs::msg::PointCloud2::SharedPtr  cloud_msg) {
    RCLCPP_INFO(this->get_logger(), "Topic from zivid received !");
...
//
void PcTopic::center_callback(const image_pros::msg::HoleCenterMsg2::SharedPtr center_msg){
    
    //set to false to hide printing
    bool print_flag = true;
    
    RCLCPP_INFO(this->get_logger(), "Topic from py received !");
